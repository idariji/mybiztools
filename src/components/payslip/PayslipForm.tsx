    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <input type="text" placeholder="Account Number *" value={payslip.employeeInfo.bankAccount} onChange={(e) => onChange({ ...payslip, employeeInfo: { ...payslip.employeeInfo, bankAccount: e.target.value } })} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8A2B] focus:border-transparent" />
          <input type="text" placeholder="Bank Name" value={payslip.employeeInfo.bankName} onChange={(e) => onChange({ ...payslip, employeeInfo: { ...payslip.employeeInfo, bankName: e.target.value } })} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8A2B] focus:border-transparent" />
          <input type="text" placeholder="Account Name" value={payslip.employeeInfo.accountName} onChange={(e) => onChange({ ...payslip, employeeInfo: { ...payslip.employeeInfo, accountName: e.target.value } })} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8A2B] focus:border-transparent" />
        </div>
      </div>
